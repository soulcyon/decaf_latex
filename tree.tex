...
\StateVar[\nodelabel{A}{1}]{(4,0)}{A0}
\FinalStateVar[\nodelabel{B}{2}]{(2,-2)}{B1} \StateVar[\nodelabel{C}{3}]{(6,-2)}{C1}
\StateVar[\nodelabel{A}{4}]{(0,-4)}{A2} \FinalStateVar[\nodelabel{C}{5}]{(4,-4)}{C2} 
\StateVar[\nodelabel{A}{6}]{(2,-6)}{A3} \FinalStateVar[\nodelabel{B}{7}]{(6,-6)}{B3}
\FinalStateVar[\nodelabel{A}{8}]{(4,-8)}{A4} \StateVar[\nodelabel{C}{9}]{(8,-8)}{C4}
\StateVar[\nodelabel{B}{10}]{(2,-10)}{B5} \StateVar[\nodelabel{C}{11}]{(6,-10)}{C5}
